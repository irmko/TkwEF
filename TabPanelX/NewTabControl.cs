...
namespace TabPanelX
{
    public partial class TabControlX : System.Windows.Forms.TabControl
    {
        public TabControlX()
        {
            InitializeComponent();
        ...
        public TabControlX(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
    ...
    public class TabPanelX : System.Windows.Forms.Panel                                //Новый контрол
    {
        public int width = 0;
        public TabControlX tabControl;  
        ...
        private void InitializeComponent()
        {
            ...
            this.tabControl = new TabControlX();
        ...
        private void Sort()
        {
            ...
            {
                panel.BackgroundImage = global::TabPanelX.Properties.Resources.tab_c_74;  //Задаем фоном, что вкладка не активна
                panel.Top = i;
                i += panel.Height;
            }

            if (tabControl.SelectedTab!=null && this.ListTabButton.ContainsKey(tabControl.SelectedTab))
            ((PanelTP)this.ListTabButton[tabControl.SelectedTab]).BackgroundImage = global::TabPanelX.Properties.Resources.tab_c_73; //Красим выделенную вкладку
        }
    ...
    public class PanelTP : System.Windows.Forms.Panel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Height = 27;
            this.Width = 128;
            this.BackgroundImage = global::TabPanelX.Properties.Resources.tab_c_74;
            ...
            Icon.Left = 3;
            Icon.Top = 5;
            Icon.Image = global::TabPanelX.Properties.Resources.green_dialbut_611;
        ...
        void Select_Item(object sender, EventArgs e) //Событие клик по вкладке
        {
            ...
            if (sender is Label)
            {
                ((TabControlX)((PanelTP)((Label)sender).Parent).key.Parent).SelectTab(((PanelTP)((Label)sender).Parent).key);
            }
            if (sender is PanelTP)
            {
                ((TabControlX)((PanelTP)sender).key.Parent).SelectTab(((PanelTP)sender).key);
            }
